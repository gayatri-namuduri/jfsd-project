    ...
    <div id="main">
        ...
        <div class="profile-container">
            ...
            <div class="profile-pic">
                <img src="displaystuprofile?id=${student.id}" alt="${student.name} Image"/>
            </div>
            ...
            <div class="profile-details">
                ...
                <div class="detail-row">
                    <b>DATE OF BIRTH:</b> <span>${student.dob}</span>
                </div>
                <div class="detail-row">
                    <b>MAJOR:</b> <span>${student.major}</span>
                </div>
                <div class="detail-row">
                    <b>LOCATION:</b> <span>${student.location}</span>
                </div>
                <div class="detail-row">
                    <b>EMAIL:</b> <span>${student.email}</span>
                </div>
                <div class="detail-row">
                    <b>CONTACT:</b> <span>${student.contact}</span>
                </div>
            </div>
        </div>
    </div>
