...
<body>
    ...
    <div id="main">
        ...
        <div class="container">
        <h3 class="text-center my-4">View All Faculty</h3>

        <div class="container">
        <div class="wrapper">
            <c:forEach items="${faclist}" var="fac">
                <div class="card-image">
                    <img src="displayfacprofile?id=${fac.id}" class="profile-img" alt="Profile Picture">
                    
                        <h3 class="card-title">${fac.name}</h3>
                        <h5 class="card-text">${fac.id}</h5>
                        <div class="button-wrapper">
                        <a href="<c:url value='displayfaculty?id=${fac.id}'></c:url>" class="btn ">View</a>&nbsp;
                    <!--     <a href="<c:url value='deletefaculty?id=${fac.id}'></c:url>" class="btn ">Delete</a> -->
                   </div>
